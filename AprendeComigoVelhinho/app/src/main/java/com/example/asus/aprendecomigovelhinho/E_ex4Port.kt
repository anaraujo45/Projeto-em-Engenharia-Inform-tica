...
import kotlinx.android.synthetic.main.activity_e_ex4_port.*
import kotlinx.android.synthetic.main.activity_g_ex3_estmei.*

class E_ex4Port : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_e_ex4_port)
    }

    fun e4_avancar_d(view: View) {

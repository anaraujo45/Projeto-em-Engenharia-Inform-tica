...
import kotlinx.android.synthetic.main.activity_f_ex2_mat.*
import kotlinx.android.synthetic.main.activity_g_ex3_estmei.*

class F_ex2Mat : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_f_ex2_mat)
    }

    fun f2_avancar_d(view: View) {
        val it = Intent(this, D_lista::class.java)
        startActivity(it)
    }

    fun corrigir(view: View){
        editText_meiodiaquarenta==null
        editText_sete==null
    }
